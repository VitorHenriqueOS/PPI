...
public class CategoriaServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection conn = new Conector().getConexao()) {
            ...
            // Tratamento específico para erro de chave estrangeira (SQL State 23000 / Error 1451)
            if (msgErro != null && msgErro.contains("foreign key constraint fails")) {
                 msgErro = "Não é possível excluir este registro pois ele está vinculado a um quarto";
            } else if (msgErro != null && msgErro.contains("Duplicate entry")){
